...
async def get_all_translations(request: Request) -> None :
    pass
...
async def get_translation(translation_id: int, request: Request) -> None :
    pass


@translation_route.put("/{translation_id}", status_code=status.HTTP_200_OK)
async def update_translation(translation_id: int, request: Request) -> None :
    pass


@translation_route.delete("/{translation_id}",
                          status_code=status.HTTP_204_NO_CONTENT)
async def delete_translation(translation_id: int, request: Request) -> None :
    pass
