...
async def get_all_taxonomies(request: Request):
    pass


@taxonomy_router.post("/", status_code=status.HTTP_201_CREATED)
async def create_taxonomy(request: Request):
    pass
...
async def update_taxonomy(taxonomy_id: int, request: Request):
    pass


@taxonomy_router.delete("/{taxonomy_id}",
                        status_code=status.HTTP_204_NO_CONTENT)
async def delete_taxonomy(taxonomy_id: int, request: Request):
    pass
